          ...
          <div className="flex flex-col justify-center gap-8 px-4 md:px-8">
            <div>
              ...
              <p className="mt-4 leading-relaxed text-[#9a8a7a]">
                We don't use gas or electricity for our main courses. Every dish
                is kissed by the heat of seasoned oak and applewood. This
                ancestral method requires patience, intuition, and a deep
          ...
          <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
            <div className="order-2 lg:order-1">
              ...
              <p className="mt-4 text-[#9a8a7a] leading-relaxed">
                "Fire is alive. It has a mood, a rhythm. My job is to listen to
                it and know exactly when the ingredient has reached its peak.
                It's not just cooking; it's a conversation."
              </p>
        ...
        <section className="mt-24 grid grid-cols-1 gap-12 md:grid-cols-3">
          <div className="text-center">
            ...
            <p className="mt-4 text-sm leading-relaxed text-[#9a8a7a]">
              ...
              partner with 12 local farms to bring the soil's story to your
              plate.
            </p>
          </div>
          <div className="text-center">
