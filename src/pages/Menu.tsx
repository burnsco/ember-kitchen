...
const wines = [
  ...
  {
    name: "Barolo Brunate, Vietti",
    region: "Piedmont, Italy",
    price: "$24 / $90",
  },
  {
    name: "Sancerre Blanc, Vacheron",
...
const SectionHeading: React.FC<{ label: string; title: string }> = ({
  label,
  title,
}) => (
  <div className="mb-8">
      ...
      <div className="mx-auto max-w-7xl px-6 py-7 md:px-10">
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            {starters.map((item) => (
              ...
              >
                ...
                <span className="shrink-0 font-medium text-[#e8a87c]">
                  {item.price}
                </span>
              </div>
            ))}
        ...
        <section className="mb-10">
          ...
          <p className="mt-4 text-center text-xs text-white/30">
            Ask your server about our full cellar list and sommelier-led
            pairings.
          </p>
        </section>
        ...
        <section className="rounded-3xl bg-[#1a140d] border border-[#e8632d]/20 p-8 text-center">
          ...
          <p className="mx-auto mt-3 max-w-md text-sm text-[#9a8a7a]">
            Seven courses guided by Chef Marlowe, paired with wines from our
            cellar. Available Tuesday through Saturday evenings.
          </p>
          <p className="mt-2 text-2xl font-serif text-[#e8a87c]">
            $145{" "}
