...
const occasions = [
	...
	"Business Dinner", "Celebration", "Other",
];
				...
				<div className="mt-12 grid grid-cols-1 gap-12 lg:grid-cols-5">
						...
						{submitted ? (
							...
							<form onSubmit={handleSubmit} className="mt-8 space-y-5">
								...
								<div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
									...
									<div>
										<label htmlFor="guests" className={labelClass}>Party Size</label>
										<select
											id="guests"
											name="guests"
											value={form.guests}
								...
								<div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
									...
									<div>
										...
										<select
											...
											className={inputClass}
										>
											<option value="" className="bg-[#1a140d]">Select a time</option>
											{times.map((t) => (
								...
								<div>
									<label htmlFor="occasion" className={labelClass}>Occasion (optional)</label>
									<select
										id="occasion"
										name="occasion"
										value={form.occasion}
					...
					<div className="lg:col-span-2 space-y-5">
							...
							<ul className="space-y-3 text-sm">
								{[
									...
									<li key={day} className="flex justify-between">
										...
										<span className={hours === "Closed" ? "text-white/25" : "text-[#e8a87c]"}>
											{hours}
										</span>
									</li>
								))}
						...
						<div className="rounded-3xl border border-white/10 bg-[#1a140d] p-6">
							...
							<p className="font-serif text-2xl text-[#f5ece1]">(212) 555-0174</p>
						...
						<div className="rounded-3xl bg-[#e8632d]/10 border border-[#e8632d]/20 p-6">
							<p className="text-sm font-medium text-[#e8a87c]">Groups of 8 or more?</p>
							<p className="mt-1 text-xs text-white/40">
								We offer exclusive private dining rooms for larger parties. Contact
								us directly to arrange a bespoke evening.
							</p>
						</div>
					</div>
				</div>
